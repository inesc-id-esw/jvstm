...
javac -cp ../../target/jvstm-1.0-SNAPSHOT.jar:. simple/SimpleUnsafeAnnotationsTest.java
...
java -cp ../../target/jvstm-1.0-SNAPSHOT.jar:. simple.SimpleUnsafeAnnotationsTest
rm simple/*.class
