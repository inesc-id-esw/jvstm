...
public class TopLevelTransaction extends ReadWriteTransaction {
    ...
    // represents the application source code transaction that is being executed; used for scheduling
    protected final int transactionId;

    public TopLevelTransaction(ActiveTransactionsRecord activeRecord, int transactionId) {
	...
	return new WriteSet(mergedTxs, this.boxesWrittenInPlace, this.boxesWritten, this.arrayWrites, this.arrayWritesCount, this);
    }
...
//      * the record previous to the commitTxRecord)
	...
	this.commitTxRecord = new ActiveTransactionsRecord(lastValid.transactionNumber + 1, transactionId, writeSet);
	...
	Scheduler.getScheduler().commitTx(transactionId);
    }
